---
name: langchain
description: LangChain 1.0 framework for building AI agents and LLM applications. Use for agent development, chains, prompt engineering, vector stores, memory management, and production LLM applications.
---
...
- **callbacks.md** - Callbacks documentation
...
- **retrieval.md** - Retrieval documentation
